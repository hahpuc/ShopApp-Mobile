...
class ShipOrderWidget extends StatefulWidget {
  const ShipOrderWidget({Key? key}) : super(key: key);

  @override
  State<ShipOrderWidget> createState() => _ShipOrderWidgetState();
}

class _ShipOrderWidgetState extends State<ShipOrderWidget>
